...
static asn_per_constraints_t asn_PER_type_fmodeSpecificInfo_constr_2 GCC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_fmodeSpecificInfo_tag2el_2[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_FrequencyInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* fmodeSpecificInfo */
};
