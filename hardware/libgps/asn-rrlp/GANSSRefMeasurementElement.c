...
static asn_per_constraints_t asn_PER_memb_codePhaseSearchWindow_constr_7 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_GANSSRefMeasurementElement_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct GANSSRefMeasurementElement, additionalAngle),
	...
	{ ATF_POINTER, 1, offsetof(struct GANSSRefMeasurementElement, codePhase1023),
...
static const int asn_MAP_GANSSRefMeasurementElement_oms_1[] = { 2, 6, 7 };
...
static const asn_TYPE_tag2member_t asn_MAP_GANSSRefMeasurementElement_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* codePhase1023 */
};
