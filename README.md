...
This driver is suitable for Android4.x 5.x and 6.x.
For higher Android version, please use [this project](https://github.com/zxcwhale/android7_gnss_hal_driver).
